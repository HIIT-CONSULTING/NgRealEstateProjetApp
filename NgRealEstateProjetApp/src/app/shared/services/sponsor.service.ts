...
export class SponsorService {
  ...
  getCandidate(id:number): Observable<Candidate>{
    return this.http.get<Candidate>(`${this.hosturlname}api/v1/getAplicantDetails/${id}`);    
  }
  ...
  update(candidate:any,id:number): Observable<any>{
    ...
    return this.http.put(`${this.hosturlname}api/v1/update/${id}`, formatedCandidate);
  }
   ...
   */  
  valide(id:number){
    return this.http.post(`${this.hosturlname}api/v1/validApplicant/${id}`,this.Vide);
  }
   ...
   */
  refus(id:number){
    return this.http.post(`${this.hosturlname}api/v1/refuseApplicant/${id}`,this.Vide);
  }
